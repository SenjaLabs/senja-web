  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        isActive 
          ...
          : "opacity-0 scale-95"
           ...
           style={{
             boxShadow: "0 8px 32px rgba(255, 112, 67, 0.3), 0 0 0 1px rgba(255, 112, 67, 0.1)",
           }}>
      ...
      <div className="relative">
        ...
        {/* Sparkle effect */}
        <div className={cn(
          "absolute -top-1 -right-1 w-2 h-2 bg-[#FFE0B2] rounded-full transition-all duration-500",
          isActive ? "animate-ping opacity-100" : "opacity-0"
        )}></div>
        <div className={cn(
          "absolute -top-1 -right-1 w-2 h-2 bg-[#FFF3E0] rounded-full transition-all duration-500",
